  ...
  <body class="product-bg">
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav-top">
            ...
            <li><a href="vitamin.php">Vitamin C and You</a></li>
            <li class="active"><a href="buy.php">Where You Buy</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    ...
    <div class="container">
       <div class="middle-content-product">
        <!-- <h1>Discover the wonders of Vitamin C</h1> -->
        <!-- <img src="img/discover.png">
        
        <p>
          <a class="btn btn-plus" href="#" role="button"></a>
        </p>
        <p>
          <span class="begin-btn" href="#" role="button">See Product</span>
        </p> -->
      </div>
    </div> <!-- /container -->
